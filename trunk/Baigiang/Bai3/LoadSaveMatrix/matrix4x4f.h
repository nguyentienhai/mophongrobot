...
inline void matrix4x4f::translate( const vector3f &trans )
{
    identity();
...
inline void matrix4x4f::translate_x( const float &dist )
{
    identity();
...
inline void matrix4x4f::translate_y( const float &dist )
{
    identity();
...
inline void matrix4x4f::translate_z( const float &dist )
{
    identity();
...
inline void matrix4x4f::rotate_x( const float &angle )
{
    float s = sin(DEGTORAD(angle));
    float c = cos(DEGTORAD(angle));
...
inline void matrix4x4f::rotate_y( const float &angle )
{
    float s = sin(DEGTORAD(angle));
    float c = cos(DEGTORAD(angle));
...
inline void matrix4x4f::rotate_z( const float &angle )
{
    float s = sin(DEGTORAD(angle));
    float c = cos(DEGTORAD(angle));
...
inline void matrix4x4f::scale( const vector3f &scale )
{
    identity();
...
inline void matrix4x4f::transformPoint( vector3f *vec )
{
    vector3f &v = *vec;
